...
for ind, res in enumerate(allResults):
    ...
    contactType = 'url'
    contact = res.find_element_by_css_selector("a[data-q='title']").get_attribute("href")
    imgs = []
    if "Request Images" in res.text:
        print("IMAGES NOT PRESENT")
        imgs.append("https://img.freepik.com/free-vector/houses-concept-illustration_114360-668.jpg")
    else:
